...
// only necessary for implementing full functionality in AR mode 
// not needed for this project

namespace ARLocation
{
    public class ModifiedWebMapLoader : MonoBehaviour
    {

         // create list to keep track of all created hotspots
        public static List<GameObject> hotspotsToVisit = new List<GameObject>();
        ...
        void BuildGameObjects()
        {
            foreach (var entry in _dataEntries)
            {
                ...
                // keep track of hotspots to place
                instance.name = entry.name;
                hotspotsToVisit.Add(instance);
